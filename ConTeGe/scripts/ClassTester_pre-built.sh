...
bm="XYPlot"
testedJar="${bmBase}/${bm}/jar/jfreechart-1.0.9_rewritten.jar"
testedJarLibs="${bmBase}/${bm}/lib/clinit.jar:${bmBase}/${bm}/lib/jcommon-1.0.12.jar"
...
cmd="java -cp ${contegeLibs}:${contege}:${contegeOwnLibs}:${testedJar}:${testedJarLibs} contege.ClassTester org.jfree.chart.plot.XYPlot ${testedJarEnvTypes} ${seed} ${maxSuffixGenTries} result.out false"
