...
public abstract class InstanceKeyDataSource implements DataSource, Referenceable, Serializable
{
    ...
    public Connection getConnection(final String username, final String password) throws SQLException {
        ...
        try {
            ...
            throw new SQLNestedException("Cannot borrow connection from pool", (Throwable)e);
        }
            ...
            this.closeDueToException(info);
            throw new SQLNestedException("Cannot borrow connection from pool", (Throwable)e4);
        }
        Label_0345: {
            if (null == password) {
            ...
            for (int i = 0; i < 10; ++i) {
                try {
                    ...
                    this.closeDueToException(info);
                    throw new SQLNestedException("Cannot borrow connection from pool", (Throwable)e5);
                }
                    ...
                    this.closeDueToException(info);
                    throw new SQLNestedException("Cannot borrow connection from pool", (Throwable)e8);
                }
    ...
    public static void XXXmyClinitXXX() {
        Clinit.logClinit("org/apache/commons/dbcp/datasources/InstanceKeyDataSource");
    }
}
